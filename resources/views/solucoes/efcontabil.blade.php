...
@section('titulo', 'SÓFOLHA Soluções Corporativas | Escrita Fiscal e Contabilidade')
            ...
            <div class="flex flex-col xl:flex-row justify-around items-center py-10 px-3">
                ...
                <div class="max-w-2xl font-normal mt-5">
                    <h2 class="font-barlow text-3xl font-semibold text-AzulPrincipal">
                        ESCRITA FISCAL e CONTABILIDADE <span class="font-barlow font-normal text-3xl">| SÓFOLHA Soluções
                            Corporativas</span>
                    </h2>
